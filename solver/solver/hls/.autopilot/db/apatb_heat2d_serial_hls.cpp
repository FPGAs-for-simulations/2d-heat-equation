...
// wrapc file define:
#define AUTOTB_TVIN_u_in "../tv/cdatafile/c.heat2d_serial_hls.autotvin_u_in.dat"
#define AUTOTB_TVOUT_u_in "../tv/cdatafile/c.heat2d_serial_hls.autotvout_u_in.dat"
#define AUTOTB_TVIN_u_out "../tv/cdatafile/c.heat2d_serial_hls.autotvin_u_out.dat"
#define AUTOTB_TVOUT_u_out "../tv/cdatafile/c.heat2d_serial_hls.autotvout_u_out.dat"
#define AUTOTB_TVIN_num_steps "../tv/cdatafile/c.heat2d_serial_hls.autotvin_num_steps.dat"
#define AUTOTB_TVOUT_num_steps "../tv/cdatafile/c.heat2d_serial_hls.autotvout_num_steps.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_u_out "../tv/rtldatafile/rtl.heat2d_serial_hls.autotvout_u_out.dat"
...
extern "C"
void heat2d_serial_hls_hw_stub_wrapper(void*, void*, hls::sim::Byte<4>);

extern "C"
void apatb_heat2d_serial_hls_hw(void* __xlx_apatb_param_u_in, void* __xlx_apatb_param_u_out, hls::sim::Byte<4> __xlx_apatb_param_num_steps)
{
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_num_steps),
#endif
  };
  port0.param = &__xlx_apatb_param_num_steps;
  ...
  static hls::sim::Memory<hls::sim::Reader, hls::sim::Writer> port1 {
    ...
    .owriter = nullptr,
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_u_in),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_u_in),
#endif
#endif
    .hasWrite = { false },
    .max_nbytes = { 0 },
  };
  port1.param = { __xlx_apatb_param_u_in };
  port1.mname = { "u_in" };
  port1.nbytes = { 8192 };
...
#ifdef POST_CHECK
#ifdef USE_BINARY_TV_FILE
    .reader = new hls::sim::Input(AUTOTB_TVOUT_PC_u_out),
#else
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_u_out),
#endif
#else
#ifdef USE_BINARY_TV_FILE
    .owriter = new hls::sim::Output(AUTOTB_TVOUT_u_out),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_u_out),
#endif
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_u_out),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_u_out),
#endif
#endif
    .hasWrite = { true },
    .max_nbytes = { 0 },
  };
  port2.param = { __xlx_apatb_param_u_out };
  port2.mname = { "u_out" };
  port2.nbytes = { 8192 };
  ...
  try {
    ...
    heat2d_serial_hls_hw_stub_wrapper(__xlx_apatb_param_u_in, __xlx_apatb_param_u_out, __xlx_apatb_param_num_steps);
